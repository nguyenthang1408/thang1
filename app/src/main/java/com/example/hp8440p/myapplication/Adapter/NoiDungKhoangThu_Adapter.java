...
public class NoiDungKhoangThu_Adapter extends BaseAdapter {

    public static List<NoiDung> KhoangThulist;
    private tab_KhoangThu_Fragment mCcontext;
    private int layout;
    ListView lv;
    Database db;
    EditText txtNhapNgay;

    public NoiDungKhoangThu_Adapter(List<NoiDung> KhoangThuList, tab_KhoangThu_Fragment mCcontext, int layout, ListView lv) {
        this.mCcontext = mCcontext;
        this.layout = layout;
        this.KhoangThulist = KhoangThuList;
        this.lv = lv;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final NoiDung noiDung = KhoangThulist.get(i);
...
//        Bat Su kien Delete
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final NoiDung nd = (NoiDung) KhoangThulist.get(i);
//                Toast.makeText(mCcontext.getActivity(), "" + nd.getNoiDung() + nd.getIdNoiDung(), Toast.LENGTH_SHORT).show();
                ...
                dialogXoa.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        db.QueryData("DELETE FROM KhoangThu WHERE id = " + nd.getIdNoiDung() + " ");
            ...
            public void onClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        db.QueryData("UPDATE KhoangThu SET noiDung= '" + noidungNew + "',soTien= '" + SoTienNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangThu SET soTien= '" + SoTienNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangThu SET theLoai= '" + TheLoaiNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangThu SET ngay= '" + NgayNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangThu SET note= '" + GhiChuNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
