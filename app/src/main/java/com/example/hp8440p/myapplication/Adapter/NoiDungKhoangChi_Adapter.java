...
public class NoiDungKhoangChi_Adapter extends BaseAdapter {
    ...
    public static List<NoiDung> KhoangChiList;
    private tab_KhoangChi_Fragment mCcontext;
    private int layout;
    ListView lv;
    Database db;
    EditText txtNhapNgay;
    public NoiDungKhoangChi_Adapter(List<NoiDung> KhoangThuList, tab_KhoangChi_Fragment mCcontext, int layout, ListView lv) {
        this.mCcontext = mCcontext;
        this.layout = layout;
        this.KhoangChiList = KhoangThuList;
        this.lv = lv;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final NoiDung noiDung = KhoangChiList.get(i);
...
//        Bat Su kien Delete
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final NoiDung nd = (NoiDung) KhoangChiList.get(i);
//                Toast.makeText(mCcontext.getActivity(), "" + nd.getNoiDung() + nd.getIdNoiDung(), Toast.LENGTH_SHORT).show();
                ...
                dialogXoa.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        db.QueryData("DELETE FROM KhoangChi WHERE id = " + nd.getIdNoiDung() + " ");
            ...
            public void onClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        db.QueryData("UPDATE KhoangChi SET noiDung= '" + noidungNew + "',soTien= '" + SoTienNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangChi SET soTien= '" + SoTienNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangChi SET theLoai= '" + TheLoaiNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangChi SET ngay= '" + NgayNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
                        db.QueryData("UPDATE KhoangChi SET note= '" + GhiChuNew + "' WHERE Id = '" + noiDung.getIdNoiDung() + "' ");
