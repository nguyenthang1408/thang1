...
public class NoiDungLoaiThu_Adapter extends BaseAdapter {
    public static List<NoiDung> loaiThuList;
    private tab_LoaiThu_Fragment mCcontext;
    private int layout;
    private ListView mListView;
    EditText txtNhapNgay;
    Database db;
    public NoiDungLoaiThu_Adapter(List<NoiDung> loaiThuList, tab_LoaiThu_Fragment context, int layout, ListView lv) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final NoiDung noiDung = loaiThuList.get(i);
...
//        ___________________________________________Bat Su kien Delete_______________________________________________
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final NoiDung nd = (NoiDung) loaiThuList.get(i);
//                Toast.makeText(mCcontext.getActivity(), "" + nd.getNoiDung() + nd.getIdNoiDung(), Toast.LENGTH_SHORT).show();
                ...
                dialogXoa.setMessage("Bạn có muốn xóa dữ liệu không?");
                dialogXoa.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        db.QueryData("DELETE FROM LoaiThu WHERE id = " + nd.getIdNoiDung() + " ");
                        Toast.makeText(mCcontext.getActivity(), "Xóa thành công", Toast.LENGTH_SHORT).show();
        ...
        // _________________________________________bat su kien edit___________________________________________________
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              final EditText txtTenNoiDung = dialog.findViewById(R.id.edittextCvUpdate);
                ...
                //_______________________________DATE___________________________
              ...
              //______________________++++UPDATE++++_______________________________
              btnUpdate.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                   ...
                   db.QueryData("UPDATE LoaiThu SET noiDung= '"+noidungNew+"',soTien= '"+SoTienNew+"' WHERE Id = '"+ noiDung.getIdNoiDung()+"' ");
                      db.QueryData("UPDATE LoaiThu SET soTien= '"+SoTienNew+"' WHERE Id = '"+ noiDung.getIdNoiDung()+"' ");
                      db.QueryData("UPDATE LoaiThu SET theLoai= '"+TheLoaiNew+"' WHERE Id = '"+ noiDung.getIdNoiDung()+"' ");
                      db.QueryData("UPDATE LoaiThu SET ngay= '"+NgayNew+"' WHERE Id = '"+ noiDung.getIdNoiDung()+"' ");
                      db.QueryData("UPDATE LoaiThu SET note= '"+GhiChuNew+"' WHERE Id = '"+ noiDung.getIdNoiDung()+"' ");
